    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          // Mostrar mensaje personalizado (en vez del contador)
          showCountdown();
          // No se reproduce música ni se muestra el botón
...
// 💖 Mensaje personalizado (reemplaza al contador)
function showCountdown() {
  const container = document.getElementById('countdown');
  if (!container) return;
  container.innerHTML = `<span style="font-size: 1.6em; font-weight: bold; color: #e60073;">💖 Te amo tanto, Yhibel 💖</span>`;
